!(function () {
    ...
    var n = function (e) {
      ...
      i = function (e) {
        var t = e.target,
          n = e.attributeName,
          i = e.oldValue;
        t.attributeChangedCallback(n, i, t.getAttribute(n));
      };
    return function (o, s) {
      var r = o.constructor.observedAttributes;
      return (
        r &&
          e(s).then(function () {
            new t(n).observe(o, {
            ...
            for (var e = 0, s = r.length; e < s; e++)
              o.hasAttribute(r[e]) &&
                i({ target: o, attributeName: r[e], oldValue: null });
          }),
        o
      );
    };
  ...
  var i = "querySelectorAll",
    ...
    f = function (e) {
        ...
        s = function (n, i) {
          ...
          if (i)
            for (
              ...
              r.call(n, (s = p[a])) &&
                (t.has(n) || t.set(n, new c()),
                (o = t.get(n)).has(s) || (o.add(s), e.handle(n, i, s)));
          else
            t.has(n) &&
              ((o = t.get(n)),
              t.delete(n),
        ...
        g = (function (e) {
            ...
            r = function t(o, s, r, a, l, c) {
              ...
              try {
                for (u.s(); !(d = u.n()).done; ) {
                  ...
                  (c || i in h) &&
                    (l
                      ? r.has(h) || (r.add(h), a.delete(h), e(h, l))
                      : a.has(h) || (a.add(h), r.delete(h), e(h, l)),
                    c || t(h[i](s), s, r, a, l, !0));
                }
              } catch (e) {
                u.e(e);
          ...
          return (
            (a.observe = function (e) {
              return l.call(a, e, { subtree: !0, childList: !0 });
            })(t),
            a
          );
        })(s, m, l, p),
      ...
      return (
        ...
        p.length && f(m[o](p)),
        {
          ...
          flush: function () {
            for (var e = g.takeRecords(), t = 0, n = e.length; t < n; t++)
              f(h.call(e[t].removedNodes, u), !1),
                f(h.call(e[t].addedNodes, u), !0);
          },
          observer: g,
          parse: f,
        }
    ...
    L = y.defineProperty,
    C = y.keys,
    D = y.getOwnPropertyNames,
    I = y.setPrototypeOf,
    _ = !self.customElements,
    N = function (e) {
      for (var t = C(e), n = [], i = new b(), o = t.length, s = 0; s < o; s++) {
        n[s] = e[t[s]];
        try {
          delete e[t[s]];
        } catch (e) {
      ...
      return function () {
        for (var s = 0; s < o; s++) i.has(s) || (e[t[s]] = n[s]);
      };
    };
  if (_) {
    var P = function () {
        var e = this.constructor;
        if (!M.has(e)) throw new T("Illegal constructor");
        var t = M.get(e);
        if (V) return j(V, t);
        var n = R.call(m, t);
        return j(I(n, e.prototype), t);
      },
      R = m.createElement,
      M = new g(),
      F = new g(),
    ...
    (self.customElements = {
      define: function (e, t) {
        if (z.has(e))
          throw new A(
            'the name "'.concat(e, '" has already been used with this registry')
          );
        M.set(t, e),
          k.set(e, t.prototype),
          z.set(e, t),
      ...
      L((P.prototype = S.prototype), "constructor", { value: P }),
      (self.HTMLElement = P),
      (m.createElement = function (e, t) {
        var n = t && t.is,
          i = n ? z.get(n) : z.get(e);
        return i ? new i() : R.call(m, e);
      }),
      "isConnected" in x.prototype ||
        L(x.prototype, "isConnected", {
          configurable: !0,
          get: function () {
            return !(
  ...
  } else if ((_ = !self.customElements.get("extends-br")))
    try {
      var $ = function e() {
      ...
      var U = "extends-br";
      self.customElements.define("extends-br", $, { extends: "br" }),
        (_ = m.createElement("br", { is: U }).outerHTML.indexOf(U) < 0);
      var K = self.customElements,
        G = K.get,
        q = K.whenDefined;
  ...
  if (_) {
    var X = function (e) {
      ...
      he = f({
        ...
        handle: function (e, t) {
          ne.has(e) &&
            (t ? ie.add(e) : ie.delete(e), ce.length && X.call(ce, e));
        },
      }).parse,
      fe = E.prototype.attachShadow;
    fe &&
      (E.prototype.attachShadow = function (e) {
        var t = fe.call(this, e);
        return ne.set(this, t), t;
      });
    var pe = function (e) {
        if (!se.has(e)) {
          var t,
    ...
    D(self)
      ...
      .forEach(function (e) {
        ...
        function n() {
          var e = this.constructor;
          if (!oe.has(e)) throw new T("Illegal constructor");
          var n = oe.get(e),
            i = n.is,
            o = n.tag;
          if (i) {
            if (ge) return me(ge, i);
            var s = Z.call(m, o);
            return s.setAttribute("is", i), me(I(s, e.prototype), i);
          }
          return te.call(this, t, [], e);
        }
        L((n.prototype = t.prototype), "constructor", { value: n }),
          L(self, e, { value: n });
      }),
      (m.createElement = function (e, t) {
        var n = t && t.is;
        if (n) {
          var i = ae.get(n);
          if (i && oe.get(i).tag === e) return new i();
        }
        var o = Z.call(m, e);
      ...
      (Y.upgrade = function (e) {
        ...
        if (t) {
          var n = ae.get(t);
          if (n) return void me(I(e, n.prototype), t);
        }
        ee.call(Y, e);
      }),
      (Y.define = function (e, t, n) {
        if (de(e))
          throw new A(
            "'".concat(e, "' has already been defined as a custom element")
          );
        var i,
          o = n && n.extends;
        oe.set(t, o ? { is: e, tag: o } : { is: "", tag: e }),
          o
            ? ((i = "".concat(o, '[is="').concat(e, '"]')),
              re.set(i, t.prototype),
              ae.set(e, t),
              ce.push(i))
            : (Q.apply(Y, arguments), le.push((i = e))),
          pe(e).then(function () {
            o
              ? (ue(m.querySelectorAll(i)), ie.forEach(X, [i]))
              : he(m.querySelectorAll(i));
          }),
          se.get(e)._(t);
      });
  }
...
function DragHandler(e, t, n, i, o, s, r, a, l, c, d, u, h, f, p, m, g, v, y) {
  ...
  let D = !1,
    ...
    M = !1;
  function F(e) {
    if (!isMouseEvent(e, i) && e.touches.length >= 2) return k(e);
...
function Engine(e, t, n, i, o, s, r) {
  const {
    ...
    I = u || !!y,
    {
      ...
      startGap: P,
      endGap: R,
    } = SlideSizes(T, x, A, n, I, o),
    M = SlidesToScroll(T, O, g, u, x, A, P, R, 2),
    { snaps: F, snapsAligned: k } = ScrollSnaps(T, C, x, A, M),
    z = -arrayLast(F) + arrayLast(N),
    { snapsContained: B, scrollContainLimit: H } = ScrollContain(O, z, k, y, 2),
    V = D ? B : k,
    { limit: W } = ScrollLimit(z, V, u),
    ...
    se = {
      ...
      scrollLooper: ScrollLooper(z, W, X, [q, X, Y]),
      scrollProgress: ee,
      scrollSnapList: V.map(ee.get),
      scrollSnaps: V,
      scrollTarget: Q,
      scrollTo: J,
      slideLooper: SlideLooper(T, O, z, _, N, F, V, X, n),
      slideFocus: oe,
...
function EmblaCarousel(e, t, n) {
  ...
  function T(t, n) {
    w ||
      ...
      S.active &&
        ...
        g.slidesInView.init(),
        g.slideFocus.init(),
        g.eventHandler.init(I),
        g.resizeHandler.init(I),
        g.slidesHandler.init(I),
        g.options.loop && g.slideLooper.loop(),
        y.offsetParent && b.length && g.dragHandler.init(I),
        (v = r.init(I, x))));
  }
  function O(e, t) {
    const n = D();
  ...
  return T(t, n), setTimeout(() => l.emit("init"), 0), I;
}
    ...
    async fn(t) {
      ...
      const A = w / 2 - E / 2,
        ...
        N =
          ...
          null != getAlignment(o) &&
          I != _ &&
          s.reference[p] / 2 - (I < C ? O : L) - m[p] / 2 < 0,
        P = N ? (I < C ? C - I : D - I) : 0;
      return {
        [f]: h[f] - P,
        data: { [f]: _, centerOffset: I - _ + P },
        reset: N,
      };
    },
  }),
